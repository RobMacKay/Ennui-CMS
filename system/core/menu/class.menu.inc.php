...
class Menu extends DB_Actions
{
    ...
    public function generate_menu_markup( $is_sub=FALSE, $subid=NULL, $use=NULL, $indent_width=12 )
    {
        ...
        foreach( $menu_array as $page )
        {
            ...
            $sel = $page_slug===$this->url_array[0] ? ' class="selected '.$class.'"' : ' class="'.$class.'"';
    ...
    public function update_menu()
    {
        ...
        try
        {
            ...
            $stmt->bindParam(":page_name", $page_name, PDO::PARAM_INT);
            $stmt->bindParam(":page_slug", $page_slug, PDO::PARAM_INT);
    ...
    private function _sort_menu_data( $menu_array=array() )
    {
        foreach( $menu_array as $page )
        {
            ...
            {
                $this->_menu[$page['page_id']] = $page;
            }
            else
            {
                $this->_menu[$page['parent_id']]['sub'][$page['page_id']] = $page;
            }
        }
    }
