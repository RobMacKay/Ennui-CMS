...
class comments
{
	...
	public function displayPublic($url_array)
	{
		...
		$disp = <<<COMMENT_MESSAGE


	  <!--// BEGIN COMMENT MESSAGE DISPLAY //-->
		<div class="entrydisplay">$content
		</div>
	  <!--// END COMMENT MESSAGE DISPLAY //-->
...
COMMENT_MESSAGE;
	...
	/**
	 * Outputs formatted XHTML to display comments and a submission form for new comments
	 *
	 * @param int $id
...
NO_COMMENT;
	 ...
	 * 
	 * Also adds JavaScript to insert input labels into the element
	 *
	 * @param int $id
